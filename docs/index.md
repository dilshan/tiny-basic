...
- [Language reference](language-reference.md) - overview of syntax, statements, and control structures.
- [Functions](function-list.md) - quick access to the built-in math, bitwise, and hardware helpers.
